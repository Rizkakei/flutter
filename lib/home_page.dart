...
import 'package:project1/planet_detail_page.dart';
  ...
  List<Map<String, dynamic>> planets = [
    {
      ...
      'rotationPeroid': 58.86, // Earth days
    ...
    },
    {
      ...
      'satellitesSent': 42,
      'surfaceArea': '7.46x10^8 km²',
      'rotationPeroid': 243, // Earth days
      'averageOrbitalSpeed': '35.0.2 km/s'
    },
    {
      'planetName': 'Earth',
      'nickName': 'Home',
    ...
    },
    {
      ...
      'rotationPeroid': 1.03, // Earth days
      'averageOrbitalSpeed': '24.0.7 km/s'
    },
    {
      'planetName': 'Jupiter',
      'nickName': 'Giant',
      ...
      'rotationPeroid': 0.41, // Earth days
      'averageOrbitalSpeed': '13.0.7 km/s'
    },
    {
      'planetName': 'Saturn',
      'nickName': 'Rings',
      ...
      'rotationPeroid':0.45 , // Earth days
    ...
    },
    {
      ...
      'rotationPeroid': 0.72, // Earth days
    ...
    },
    {
      ...
      'satellitesSent': 1,
      'surfaceArea': '7.46x10^9 km²',
      'rotationPeroid': 0.67, // Earth days
  ...
  Path _createDashedPath(Path source) {
    ...
    for (PathMetric measurePath in source.computeMetrics()) {
      while (distance < measurePath.length) {
        ...
        final Path extracPath = 
            measurePath.extractPath(distance, distance + dashWidth);
        dashedPath.addPath(extracPath, Offset.zero);
        distance += length;
      }
    }
    return dashedPath;
